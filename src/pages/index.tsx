  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Change web3 culture by combining memes, decentralized storage solutions, and degen shitcoin trade and gambling."
        />
      ...
      <main className={`${styles.main} ${inter.className}`}>
        ...
        <p style={{ fontSize: 14 }}>
          Introducing the <b>MEME CRAP BOOK</b>, a project that will change web3 culture by
          combining{" "}
          <b>memes, decentralized storage solutions, and degen shitcoin trade and gambling</b>. This
          effort aims to capture the ever-changing meme culture in a digital compendium called the
          MEME CRAP BOOK, ensuring that each item is immortalized on the blockchain. The $MEMECRAP
          memecoin on SOLANA, along with IPFS as the primary store for the MEME CRAP BOOK and
          potential expansions to Bitcoin inscriptions, intends to promote decentralized social
          media and make memes unstoppable.
        </p>
        <h3 style={{ marginTop: 36, fontSize: 21, fontWeight: 700 }}>
          Memecoin on the most Degen chain + This digital book is linked with metadata to the token
          and the Book has even more!!
        ...
        <p style={{ fontSize: 14, fontStyle: "italic", marginTop: 21 }}>
          All unminted and unpublished memes will be archived in Meme Crap Book.
        </p>

        <div style={{ marginTop: 60 }}>
          <h2 style={{ fontSize: 28, fontWeight: 700 }}>
            Meme Crap Book – a collection of all archived memes.
          </h2>
        ...
        <div style={{ marginTop: 100 }}>
          ...
          <p style={{ fontSize: 14, marginTop: 38 }}>
            *disclaimer I used DEX a lot and lost a lot, but still have no idea what am I doin*
          </p>
        ...
        <div style={{ marginTop: 100 }}>
          <div>
            <Link href="https://t.me/MemeCrapBook" style={{ fontSize: 14 }}>
              Telegram: @MemeCrapBook
            </Link>
          </div>
          <div>
            <Link href="https://x.com/MemeCrapBook" style={{ fontSize: 14, marginBottom: 20 }}>
              Twitter: @MemeCrapBook
            </Link>
          </div>
          <div>
            <Link href="/whitepaper.pdf" style={{ fontSize: 14, marginBottom: 20 }}>
              Whitepaper: memecrapbook.wtf/whitepaper.pdf
            </Link>
          </div>
